...
function groupEdit(editorId) {
	...
	var groupStyles = groupC.className.split(" ");
	edStyles.value = groupStyles[groupStyles.length - 1];
...
function groupApply(editorId) {
	...
	var groupStyles = groupC.className.split(" ");
	var oldStyle = groupStyles[groupStyles.length - 1]; // the last one is a custom style
	...
	groupT.style.backgroundColor = groupC.style.backgroundColor;
